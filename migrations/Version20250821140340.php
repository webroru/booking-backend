 ...
 */
final class Version20250821140340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client ADD aj_pes_username VARCHAR(255) DEFAULT NULL, ADD aj_pes_password VARCHAR(255) DEFAULT NULL, CHANGE check_in_time check_in_time TIME NOT NULL');
